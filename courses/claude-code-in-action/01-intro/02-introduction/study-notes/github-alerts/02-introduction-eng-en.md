# Introduction — Engineering Perspective
...
![Course Roadmap To Exam Domains](../../visuals/course-roadmap-to-exam-domains.svg)
...
- Understanding of **coding assistants** as a category and where Claude Code fits
- Deep dive into Claude Code's **differentiating features** (tool use, agentic loop, configuration)
- Practical, project-based walkthrough — not just theory
- Optimization strategies you can apply to real-world engineering workflows
