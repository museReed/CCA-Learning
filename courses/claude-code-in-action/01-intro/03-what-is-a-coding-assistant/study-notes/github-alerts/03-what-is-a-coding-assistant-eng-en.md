...
sequenceDiagram
    ...
    U->>CA: "What does main.go do?"
    CA->>LM: Question + tool descriptions
    LM->>CA: "ReadFile: main.go"
    CA->>FS: Read main.go
    FS->>CA: File contents
    CA->>LM: File contents
    LM->>CA: Final answer with code context
    CA->>U: Informed response
```
