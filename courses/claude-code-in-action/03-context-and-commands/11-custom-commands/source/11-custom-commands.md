...
1. Create a new directory called `commands` inside it

1. Create a new markdown file with your desired command name (like `audit.md`)
...
1. Runs `npm audit fix` to apply updates

1. Runs tests to verify the updates didn't break anything
