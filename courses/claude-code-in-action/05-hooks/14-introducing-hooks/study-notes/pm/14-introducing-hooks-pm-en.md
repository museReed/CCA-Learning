...
![Hook vs Prompt Decision](../../visuals/hook-vs-prompt-decision.svg)
*Figure: Decision framework for choosing hooks (deterministic enforcement) vs. prompt rules (flexible guidance).*
