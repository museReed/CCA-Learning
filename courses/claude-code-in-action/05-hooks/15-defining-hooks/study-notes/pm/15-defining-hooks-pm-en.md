...
![Four-Step Hook Definition](../../visuals/four-step-process.svg)
...
**PM Takeaway**: "Automatically after every edit" + "should not block" = PostToolUse with exit code 0. This is a quality enhancement, not a compliance gate.
</details>
