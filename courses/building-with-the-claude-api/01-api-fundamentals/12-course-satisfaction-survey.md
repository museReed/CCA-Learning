...
# Course Satisfaction Survey - Anthropic API
    ...
    const wrapperSelector = "div.quiz[data-quiz=1ob7ltrefmiwc]";
    ...
    function showQuiz(data) {
        if (data.success) {
            ...
            $('.quiz').html(data.quiz_html);
                ...
                $('html, body, #lesson-main-content').animate({ scrollTop: 0 }, 0);
    ...
    function getRequestData(submit) {
        var requestData = {
            ...
            requestData['quiz_id'] = '1ob7ltrefmiwc';
