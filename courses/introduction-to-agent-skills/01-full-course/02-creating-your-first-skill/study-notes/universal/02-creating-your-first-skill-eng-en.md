...
| Source | introduction-to-agent-skills / Lesson 02 |
...
**Q1:** What is Bullet points of specific changes made?
**A1:** Bullet points of specific changes made

**Q2:** What is Group related changes together?
**A2:** Group related changes together

**Q3:** What is Mention any files deleted or renamed?
**A3:** Mention any files deleted or renamed

**Q4:** Explain: A skill is a directory containing a SKILL.md file with metad...
**A4:** A skill is a directory containing a SKILL.md file with metadata (name, description) in frontmatter and instructions below

**Q5:** Explain: Claude loads only skill names and descriptions at startup, t...
**A5:** Claude loads only skill names and descriptions at startup, then matches incoming requests against those descriptions using semantic matching

**Q6:** Explain: You get a confirmation prompt before Claude loads the full s...
**A6:** You get a confirmation prompt before Claude loads the full skill content into context
