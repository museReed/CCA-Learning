...
預建的 HTML 頁面（774 頁），可直接在瀏覽器中閱讀，支援角色 × 語言切換。
...
|------|------|
| 課程 | 7 門（全部完整） |
| 已完成課堂 | 137 堂（114 + 23 新課程） |
| 學習筆記 | 822 份（137 課 × eng/pm × en/zh-TW/zh-CN） |
| SVG 圖表 | 218 個（含 EN 原版 + zh-TW 版） |
| 翻譯 JSON | 125 個（125 支影片 × 逐句 EN/zh-TW/zh-CN） |
| 雙語 SRT | 250 個（125 × zh-TW/zh-CN） |
| 逐幀學習指南 | 14,970 幀 + 125 個 Markdown 導覽 |
| HTML 頁面 | 822 頁 |
